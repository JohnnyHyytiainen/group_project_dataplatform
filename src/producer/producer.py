        ...
        while True:
            ...
            if random.random() < 0.20:
                error_type = random.choice([
                    "extreme_temp", "extreme_rpm", "extreme_vibration",
                    "null_value", "sensor_offline", "missing_id",
                ...
                # --- NYTT - ETL SMUTS ---
                    ...
                    messy_names = {
                        "washing_machine": ["WASHING MACHINE", "washing-machine", " Washing_Machine "],
                        "dryer": [" DRYER ", "Dryer", "dryer "],
                        "dishwasher": ["DishWasher", "dish washer", "DISHWASHER"],
                        "drying_cabinet": ["DryingCabinet", "drying cabinet", " DRYING_CABINET"]
                    }
                    event["appliance_type"] = random.choice(messy_names[event["appliance_type"]])
