...
# Skapande av enkla kommandon för att välja vilket layer vi vill köra.
import argparse
import logging
import time
import sys
...
from src.gold.gold_etl_job import run_gold_etl
from src. gold.gold_daily_aggr import run_daily_aggregation
...
def main(argv=None) -> int:
    ...
    try:
        ...
        end_time = time.time()
        logger.info(f"Pipeline finished successfully in {round(end_time - start_time, 2)} seconds!")
